...
let g:pdv_cfg_Version = "$Id `strftime('%Y-%m-%d %H:%M:%S')`Z 7color $"
let g:pdv_cfg_Copyright = "Copyright (c) 2010-2012 Seven color. (http://www.7color.org)"
let g:pdv_cfg_License = "http://www.opensource.org/licenses/bsd-license.php  New BSD License"
